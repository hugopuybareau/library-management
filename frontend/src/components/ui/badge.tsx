  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium font-body transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        book: "border-transparent bg-info/20 text-info",
        periodic: "border-transparent bg-primary/20 text-primary",
        thesis: "border-transparent bg-success/20 text-success",
        report: "border-transparent bg-muted text-muted-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
